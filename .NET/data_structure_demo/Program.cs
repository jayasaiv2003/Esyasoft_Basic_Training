...
namespace Data_structures_demo
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //tuple 
            Tuple<Student,Student,Student> st = new Tuple<Student,Student,Student>(first,second,third);
            Console.WriteLine($"First element: {st.Item1.name}");
            Console.WriteLine($"Second element: {st.Item2.name}");
            Console.WriteLine($"Third element: {st.Item3.name}");
